...
================================================================================
PARTIE 4 : ORCHESTRATION & ENTRAÎNEMENT (Main Script)
================================================================================
Point d'entrée principal pour lancer :
- Le prétraitement (--mode preprocess)
- L'entraînement (--mode train)
- L'évaluation (--mode test)
"""
...
def main():
    ...
    if args.mode in ['test', 'all']:
        ...
        # Générer l'image combinée avec Pillow
        try:
            from src.utils.image_utils import combine_results_images
            combine_results_images()
        except ImportError:
            print("Pillow non installé ou module introuvable.")
        except Exception as e:
            print(f"Erreur lors de la génération de l'image combinée: {e}")
